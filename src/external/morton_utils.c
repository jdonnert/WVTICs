...
static inline uint32_t spread3D_32 ( uint32_t v )
{
    v &= 0x3ff;
...
static inline uint32_t compress3D_32 ( uint32_t v )
{
    v &= 0x9249249u;
    v = ( v | ( v >> 2 ) ) & 0xc30c30c3u;
    v = ( v | ( v >> 4 ) ) & 0x0f00f00fu;
...
static inline uint64_t spread3D_64 ( uint64_t v )
{
    v &= 0x1fffff;
...
static inline uint64_t compress3D_64 ( uint64_t v )
{
...
static const uint8_t m2p3D[24][8] = {
...
static const uint8_t p2m3D[24][8] = {
